...
public class DbConstants {
    ...
    public  static final String COLUMN_ATTENDANC_ID = "attendance_id";
    public  static final String COLUMN_ATTENDANC_DATE = "attendance_date";
    public  static final String COLUMN_ATTENDANC_TIME = "attendance_time";
    ...
    public static final String CREATE_TABLE1 =
            "CREATE TABLE " + TABLE_NAME1  + " ("
                            + COLUMN_KINTAI_ID  + " INTEGER PRIMARY KEY NOT NULL,"
                            + COLUMN_KINTAI_DATE + " TEXT NOT NULL"
                            + " );";
    public static final String CREATE_TABLE2 =
            "CREATE TABLE " + TABLE_NAME2  + " ("
                            + COLUMN_ATTENDANC_ID  + " INTEGER PRIMARY KEY NOT NULL,"
                            + COLUMN_KINTAI_ID + " INTEGER NOT NULL, "
                            + COLUMN_ATTENDANC_DATE + " TEXT NOT NULL, "
                            + COLUMN_ATTENDANC_TIME + " TEXT DAFAULT '9:00' NOT NULL, "
    ...
    public static final String SQL_SELECT_ATTENDANC =
    		" SELECT " + COLUMN_ATTENDANC_DATE + ", " + COLUMN_ATTENDANC_TIME +
